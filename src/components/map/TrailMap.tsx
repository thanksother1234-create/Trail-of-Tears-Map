  ...
  return (
    <div className="space-y-4">
      <div className="paper-panel relative overflow-hidden rounded-[1.9rem] p-3 sm:p-4">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_14%,rgba(195,143,53,0.18),transparent_24%),radial-gradient(circle_at_18%_72%,rgba(120,145,110,0.16),transparent_28%),radial-gradient(circle_at_56%_48%,rgba(255,255,255,0.24),transparent_30%),linear-gradient(180deg,rgba(255,255,255,0.18),rgba(239,230,214,0.06))]" />
